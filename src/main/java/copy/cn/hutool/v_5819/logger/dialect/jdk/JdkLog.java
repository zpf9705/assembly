...
import copy.cn.hutool.v_5819.logger.AbstractLog;
...
public class JdkLog extends AbstractLog {
	...
	// ------------------------------------------------------------------------- Log
	@Override
	public void log(String fqcn, copy.cn.hutool.v_5819.logger.level.Level level, Throwable t, String format, Object... arguments) {
		Level jdkLevel;
		switch (level) {
			case TRACE:
