 ...
 * processing methods, defined in {@link top.osjf.assembly.sdk.client.Client}.
 * <p>
 * After the request, the corresponding response body will be transformed according to the
 * rewritten {@link top.osjf.assembly.sdk.client.PreProcessingResponseHandler} and
 * {@link top.osjf.assembly.sdk.client.ResponseConvert}.</p>
 *
 * @author zpf
 * @since 1.1.0
 */
