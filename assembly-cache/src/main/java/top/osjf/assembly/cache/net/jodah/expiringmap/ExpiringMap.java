package top.osjf.assembly.cache.net.jodah.expiringmap;

import top.osjf.assembly.cache.net.jodah.expiringmap.internal.Assert;
import top.osjf.assembly.cache.net.jodah.expiringmap.internal.NamedThreadFactory;
...
public class ExpiringMap<K, V> implements ConcurrentMap<K, V> {
  ...
  private static class EntryTreeHashMap<K, V> extends HashMap<K, ExpiringEntry<K, V>> implements EntryMap<K, V> {
    ...
    final class EntryIterator extends AbstractHashIterator implements Iterator<Entry<K, V>> {
  ...
  private static <K, V> Entry<K, V> mapEntryFor(final ExpiringEntry<K, V> entry) {
