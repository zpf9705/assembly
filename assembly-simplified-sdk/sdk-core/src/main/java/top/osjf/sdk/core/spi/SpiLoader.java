...
public final class SpiLoader<S> {
    ...
    //The default spiLoader internal logger.
    private static final InternalLogger LOG = InternalLoggerFactory.getInstance(SpiLoader.class);
    ...
    private boolean shouldUseContextClassloader = false;
    ...
    public static <T> SpiLoader<T> of(Class<T> service) {
        SdkArgs.notNull(service, "SPI class cannot be null");
        SdkArgs.isTrue(service.isInterface() || Modifier.isAbstract(service.getModifiers()),
    ...
    /**
     * Set whether to use the {@code ClassLoader} loader with context for this call loading.
     * @param shouldUseContextClassloader use the {@code ClassLoader} loader with context ?
     */
    public void setShouldUseContextClassloader(boolean shouldUseContextClassloader) {
        this.shouldUseContextClassloader = shouldUseContextClassloader;
    }
    ...
    public S loadInstance(Class<? extends S> clazz) {
        SdkArgs.notNull(clazz, "SPI class cannot be null");
    ...
    public S loadInstance(String aliasName) {
        SdkArgs.hasText(aliasName, "aliasName cannot be empty");
