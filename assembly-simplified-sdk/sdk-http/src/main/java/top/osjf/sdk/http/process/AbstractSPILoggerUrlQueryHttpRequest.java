...
/**
 * Extends for {@code AbstractUrlQueryHttpRequest} to provider a {@code Client}
...
public abstract class AbstractSPILoggerUrlQueryHttpRequest<R extends AbstractHttpResponse>
        extends AbstractUrlQueryHttpRequest<R> {
