...
package top.osjf.sdk.http.feign.google;
...
/**
 * The calling method of {@code GoogleHttp} uses the
...
public class GoogleFeignClientHttpRequestExecutor extends AbstractFeignClientHttpRequestExecutor {
     ...
     */
    public GoogleFeignClientHttpRequestExecutor() {
     ...
     */
    public GoogleFeignClientHttpRequestExecutor(HttpTransport transport) {
     ...
     */
    public GoogleFeignClientHttpRequestExecutor(HttpRequestFactory httpRequestFactory) {
     ...
     *                         {@code GoogleHttpClient} instance.
     */
    public GoogleFeignClientHttpRequestExecutor(GoogleHttpClient googleHttpClient) {
