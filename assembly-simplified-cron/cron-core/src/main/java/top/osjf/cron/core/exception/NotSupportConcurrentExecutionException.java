...
/**
 * This exception indicates that a repository class {@link CronTaskRepository}
 * does not support concurrent task execution.
 *
 * @author <a href="mailto:929160069@qq.com">zhangpengfei</a>
 * @since 3.0.2
 * @see CronTaskRepository#isSupportConcurrentExecution
 */
public class NotSupportConcurrentExecutionException extends CronInternalException {
