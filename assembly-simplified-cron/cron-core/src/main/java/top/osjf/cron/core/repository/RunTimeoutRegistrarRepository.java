...
public interface RunTimeoutRegistrarRepository
     ...
     */
    String register(String expression, TaskBody body, RunningTimeout timeout)
     ...
     * @throws UnsupportedTaskBodyException if input {@code TaskBody} is not supported.
     */
    void registerRunTimes(String expression, TaskBody body, int times,
                          RunningTimeout timeout) throws CronInternalException, UnsupportedTaskBodyException;
