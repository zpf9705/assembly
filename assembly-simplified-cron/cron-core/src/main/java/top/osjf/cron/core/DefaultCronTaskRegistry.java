...
public class DefaultCronTaskRegistry implements CronTaskRegistry {
    ...
    private final CronTaskRepository<String, Runnable> cronTaskRepository;

    public DefaultCronTaskRegistry(CronTaskRepository<String, Runnable> cronTaskRepository) {
