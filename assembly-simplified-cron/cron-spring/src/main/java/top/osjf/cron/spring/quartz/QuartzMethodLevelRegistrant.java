...
/**
 * Method level builder module for {@link QuartzRegistrant}.
 *
...
public class QuartzMethodLevelRegistrant extends QuartzRegistrant {
    ...
    public QuartzMethodLevelRegistrant(String cronExpression, Method method) {
        super(cronExpression, JobBuilder.newJob(MethodJob.class)
