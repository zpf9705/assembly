...
/**
 * <strong>The scope explanation of the {@code ----------------} tag comes
 * from {@link org.springframework.scheduling.annotation.EnableScheduling EnableScheduling}.
 * </strong>
 * <p>
 * <strong>--------------------------------------------------</strong>
 * <p>
 ...
 *
 * <p> Using {@link SchedulingRepository} makes it very easy to dynamically register scheduled tasks.
 * <p>Here is a set of listeners that use {@link SchedulingRepository} to terminate tasks when called
 * more than 6 times. For more details, please refer to {@link SchedulingRepository}.
 * <pre>
 *     {@code
 * Component
 * EnableScheduling
