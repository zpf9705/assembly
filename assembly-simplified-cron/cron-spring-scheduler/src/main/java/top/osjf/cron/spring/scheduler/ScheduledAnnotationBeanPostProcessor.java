...
//            applicationContext.publishEvent(new SchedulingTaskRegisteredEvent(this));
//    }
//
...
//            processScheduled((Cron) annotation, method, bean);
//        }
//    }
//
//    /**
...
//                && Arrays.stream(profiles).noneMatch(activeProfiles::contains)) {
//            return;
//        }
