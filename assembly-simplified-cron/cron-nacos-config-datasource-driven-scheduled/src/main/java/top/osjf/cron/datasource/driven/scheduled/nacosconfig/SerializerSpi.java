 ...
 * of a Nacos configuration task element serializer and define its priority order.
 *
 * <p>This annotation is applied to classes implementing {@link NacosConfigTaskElementSerializer},
 * with the {@link #order()} method specifying their loading priority. Lower values indicate higher priority.
