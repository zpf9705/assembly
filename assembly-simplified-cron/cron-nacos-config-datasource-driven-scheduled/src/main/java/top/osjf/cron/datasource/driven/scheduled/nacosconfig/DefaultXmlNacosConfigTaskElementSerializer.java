...
/**
 * Default XML serializer for {@link NacosConfigTaskElement} list.
 *
 * <p>This class provides serialization and deserialization between a list of {@link NacosConfigTaskElement}
 ...
 *     &lt;!-- Additional fields are mapped based on NacosConfigTaskElement properties --&gt;
 *   &lt;/element&gt;
 *   &lt;element&gt;
 ...
 * @since 3.0.2
 */
public class DefaultXmlNacosConfigTaskElementSerializer implements NacosConfigTaskElementSerializer {
    ...
    /** Child element tag name representing a single {@link NacosConfigTaskElement}.*/
    ...
    /**
     * Constructs a new {@code DefaultXmlNacosConfigTaskElementSerializer} to init a {@link XStream}
     * with any default settings.
     */
    public DefaultXmlNacosConfigTaskElementSerializer() {
        xstream = new XStream();
        xstream.allowTypes(new Class[]{ ArrayList.class, NacosConfigTaskElement.class });
    ...
    public List<NacosConfigTaskElement> deserialize(@NotNull String configInfo) {
        return (List<NacosConfigTaskElement>) xstream.fromXML(configInfo);
    }
