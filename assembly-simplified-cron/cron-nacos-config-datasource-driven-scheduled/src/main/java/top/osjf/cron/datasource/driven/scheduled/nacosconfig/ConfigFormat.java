...
/**
 * Configuration format enum, representing the types of configuration files supported by Nacos Config.
 *
 * <p>This enum defines various formats supported by Nacos client and server when handling configurations.
 * Each format corresponds to a specific parsing method and use case.</p>
 *
