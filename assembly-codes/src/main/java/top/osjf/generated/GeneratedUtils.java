...
public final class GeneratedUtils {
    ...
    /** Setting {@link Generated} about infos.*/
    static final Map<String, Object> generatedMap = new LinkedHashMap<>();
    ...
    static {
        ...
        //since 1.1.6 add @Generated
        generatedMap.put("value","auto generated by " + id + " - " + version);
        generatedMap.put("date", "");
        generatedMap.put("comments", "Java classes automatically generated using annotation processors are often " +
                "suitable for fixed code scenarios.");
        generatedMap.put("dateRun", (Runnable) () -> generatedMap.put("date",
    ...
    public static String codeAppenderToString(CodeAppender appender) {
        ...
        addGeneratedAnnotation(classAppend, importAppend);
    ...
    //since 1.1.6
    private static void addGeneratedAnnotation(StringBuilder classAppend, StringBuilder importAppend){
        classAppend.append(ANNOTATION_PREFIX).append(Generated.class.getSimpleName());
        ((Runnable) (generatedMap.get("dateRun"))).run();
        String annotationContent = generatedMap.keySet()
                        .stream().filter(key-> !Objects.equals(key, "dateRun"))
                .map(key -> key +
                                EQUAL_COMMA +
                                QUO_MARK +
                                generatedMap.get(key) +
                                QUO_MARK).collect(Collectors.joining(
                                        JAVA_COMMA_WORD+LINE_BREAK));
            classAppend.append(LEFT_BRACKET)
                    .append(annotationContent)
                    .append(RIGHT_BRACKET);
            classAppend.append(LINE_BREAK);
        addImport(Generated.class.getName(),importAppend);
    }
