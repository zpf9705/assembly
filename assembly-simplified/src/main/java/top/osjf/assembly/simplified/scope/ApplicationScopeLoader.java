 ...
 * {@link org.springframework.web.context.annotation.ApplicationScope} with
 * additional loading function.
 *
 * @author <a href="mailto:929160069@qq.com">zhangpengfei</a>
 * @since 2.1.6
 */
public interface ApplicationScopeLoader extends ScopeLoader {
    @Override
    default SupportScopeType type(){
        return SupportScopeType.APPLICATION;
    }
}
