 ...
 * logging to help the user diagnose what {@link DataSource} configuration classes are loaded.
 *
...
public class DatasourceDrivenCondition extends SourceClassMessageCondition {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext context,
        ...
        try {
            BindResult<DataSource> specified = Binder.get(environment)
                    .bind("spring.schedule.cron.scheduled-driven.data-source", DataSource.class);
