...
/**
 * Callback interface that can be implemented by beans wishing to customize ssh client's
 * {@link ClientBuilder ssh client builder} before it is used.
 *
...
public interface SshClientBuilderCustomizer {
    ...
    /**
     * Customize the ssh client builder.
